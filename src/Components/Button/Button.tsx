    ...
    switch (type) {
      case 'primary':
        return {
          ...
          textColor: currentTheme.text.inverted,
        };
      case 'secondary':
        return {
          backgroundColor: currentTheme.primary.light,
          textColor: currentTheme.text.default,
        };
      case 'danger':
        return {
          backgroundColor: currentTheme.system.infoRed,
          textColor: currentTheme.text.default,
        };
      default:
        return {
  ...
  return (
        ...
        setButtonSize(),
        {
          backgroundColor:
            state.pressed && !disabled
              ? shadeColor(variantType.backgroundColor, 20)
              : variantType.backgroundColor,
        },
    ...
    >
      {typeof children == 'string' ? (
        <ThemedText.Text
          style={{ color: variantType.textColor, textAlign: 'center' }}
          numberOfLines={1}
        >
          {children}
        </ThemedText.Text>
